...
class Player(GameSprite):
  ...
  def fire(self):
      bullet = Bullet('пуля.jpg', self.rect.centerx, self.rect.top, 15, 20, 15)
      bullets.add(bullet)
...
#создаем спрайты
packman = Player('ufo.png', 5, win_height - 80, 80, 80, 0, 0)
monster = Enemy('en_r.png', win_width - 80, 180, 80, 80, 5)
final_sprite = GameSprite('wall.png', win_width - 85, win_height - 100, 80, 80)
